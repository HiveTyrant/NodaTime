...
using NodaTimeWpfApplication.BLL;
using NodaTimeWpfApplication.Properties;
using NodaTimeWpfApplication.Utils;
using NodaTimeWpfApplication.Views;
...
namespace NodaTimeWpfApplication.ViewModels
{
    ...
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public override void Initialize()
        {
            ...
            {
                MessageBox.Show(
                    "Another version af NodaTimeWpfApplication.exe is already started.\r\n\r\nPlease close the program.",
        ...
        private void GetTerminalNo(bool throwIfNotFound = false)
        {
            ...
            if (Environment.GetCommandLineArgs().Length < 2)
            {
                ...
                if (throwIfNotFound)
                {
                    ...
                    throw new ApplicationException(Resources.TerminalNoParseError + " ?" + Environment.NewLine + "Use ex. 'NodaTimeWpfApplication.exe 21' in the program shortcut");
                }
            }
            else
            {
